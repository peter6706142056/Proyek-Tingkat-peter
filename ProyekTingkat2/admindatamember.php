...
<html>
    ...
    <body>
        ...
        <div class="panel-heading">
            ...
            <a href="" class="btn btn-primary" title="Tambah Artist"><span>Tambah Member</span></a>
        </div>
            <div class="scrollit">
            <table class = "table table-fixed">
                ...
                <tbody>
                    <?php
                        include('koneksi.php');
                        $ambil_data=mysql_query("select * from Member order by Username desc limit 10")or die (mysql_error());
